...
class FBXIMPORTERUTILPLUGIN_API UBFL_CreateBP : public UBlueprintFunctionLibrary
{
	...
	static void GeneratePlanesBlueprint(const FString& FBXPath, const FString& AssetPath, UStaticMesh* TarMesh, UMaterialInterface* TarMaterial);
	...
	static UBlueprint* CreatePlanesBlueprint(
		...
		UStaticMesh* TarMesh, UMaterialInterface* TarMaterial
	);
};
