...
class FBXIMPORTERUTILPLUGIN_API UBFL_CreateBP : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable, CallInEditor, Category = "FBX Parser|Editor", meta = (DevelopmentOnly))
	static void GenerateRunWay15LightModelBlueprint(const FString& FBXPath, const FString& AssetPath, UDataTable* dt);

	UFUNCTION(BlueprintCallable, CallInEditor, Category = "FBX Parser|Editor", meta = (DevelopmentOnly))
	static void GenerateRunWay15LightModelBlueprint_HISM(const FString& FBXPath, const FString& AssetPath, UDataTable* dt);
	...
	UFUNCTION(BlueprintCallable, CallInEditor, Category = "FBX Parser|Editor", meta = (DevelopmentOnly))
	static UBlueprint* CreateTarModelBlueprint(const FString& PackageName, UStaticMesh* TarMesh, const FParsedMeshData_FFSLightModel& modelMesh, int TarVariant);

	UFUNCTION(BlueprintCallable, CallInEditor, Category = "FBX Parser|Editor", meta = (DevelopmentOnly))
	static UBlueprint* CreateTarModelBlueprint_HISM(const FString& PackageName, UStaticMesh* TarMesh, const FParsedMeshData_FFSLightModel& modelMesh, int TarVariant);
};
